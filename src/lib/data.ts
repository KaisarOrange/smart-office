export const ruang = [
	{ ruang: 'AI', img: 'https://source.unsplash.com/t1PaIbMTJIM' },
	{ ruang: 'RPL', img: 'https://source.unsplash.com/1LLh8k2_YFk' },
	{ ruang: 'Product', img: 'https://source.unsplash.com/5aiRb5f464A' },
	{ ruang: 'Design', img: 'https://source.unsplash.com/_x335IZXxfc' },
	{ ruang: 'Architect', img: 'https://source.unsplash.com/wD1LRb9OeEo' }
];

export const posts = [
	{
		author_name: 'Alif Ayodya',
		author_img: '/alif.png',
		ruang: 'AI',
		img: 'https://source.unsplash.com/t1PaIbMTJIM',
		title: 'Welcome to the Aperture Science computer-aided enrichment center',
		content: `<div class="tiptop"><h2> Hi there,</h2> <p>this is a <em>basic</em> example of <strong>tiptap</strong>. Sure, there are all kind of basic text styles you’d probably expect from a text editor. But wait until you see the lists:</p><ul><li>That’s a bullet list with one …</li><li>… or two list items.</li></ul><p>Isn’t that great? And all of that is editable. But wait, there’s more. Let’s try a code block:</p><pre><code class="language-css">body {display: none;}</code></pre><p>I know, I know, this is impressive. It’s only the tip of the iceberg though. Give it a try and click a little bit around. Don’t forget to check the other examples too.</p><blockquote>Wow, that’s amazing. Good work, boy! 👏<br />— Mom</blockquote</div>`
	},

	{
		...
		ruang: 'RPL',
		title: 'Safety notice',
		img: 'https://source.unsplash.com/1LLh8k2_YFk',
		content:
...

	{
		...
		img: 'https://source.unsplash.com/5aiRb5f464A',
	...
	{
		author_name: 'James Hamilton',
		author_img: 'https://source.unsplash.com/hr7eefjrekI',
		ruang: 'Design',
		title: 'This was a triumph',
		img: 'https://source.unsplash.com/_x335IZXxfc',
		content: `<h2> Hi there,</h2> <p>this is a <em>basic</em> example of <strong>tiptap</strong>. Sure, there are all kind of basic text styles you’d probably expect from a text editor. But wait until you see the lists:</p><ul><li>That’s a bullet list with one …</li><li>… or two list items.</li></ul><p>Isn’t that great? And all of that is editable. But wait, there’s more. Let’s try a code block:</p><pre><code class="language-css">body {display: none;}</code></pre><p>I know, I know, this is impressive. It’s only the tip of the iceberg though. Give it a try and click a little bit around. Don’t forget to check the other examples too.</p><blockquote>Wow, that’s amazing. Good work, boy! 👏<br />— Mom</blockquote>`
	},
	{
		author_name: 'James Hamilton',
		author_img: 'https://source.unsplash.com/hr7eefjrekI',
		ruang: 'Architect',
		img: 'https://source.unsplash.com/wD1LRb9OeEo',
		title: 'This was a triumph',
		content: `<h2> Hi there,</h2> <p>this is a <em>basic</em> example of <strong>tiptap</strong>. Sure, there are all kind of basic text styles you’d probably expect from a text editor. But wait until you see the lists:</p><ul><li>That’s a bullet list with one …</li><li>… or two list items.</li></ul><p>Isn’t that great? And all of that is editable. But wait, there’s more. Let’s try a code block:</p><pre><code class="language-css">body {display: none;}</code></pre><p>I know, I know, this is impressive. It’s only the tip of the iceberg though. Give it a try and click a little bit around. Don’t forget to check the other examples too.</p><blockquote>Wow, that’s amazing. Good work, boy! 👏<br />— Mom</blockquote>`
	},
	{
